class CSProjModifier
  def fix(doc)
	...
	# Add XML Serialization reference
	xml_serialization_ref = Element.new("Reference")
	xml_serialization_ref.attributes["Include"] = "System.XML.Serialization"
	doc.elements["Project/ItemGroup/Reference"].parent.add xml_serialization_ref
